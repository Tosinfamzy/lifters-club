/**
 * OpenAPI 3.1 Specification for Lifters Club API
 *
 * Manually maintained documentation spec. When adding or modifying routes,
 * update the corresponding path and schema definitions here.
 */
